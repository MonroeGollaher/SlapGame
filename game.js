...
let players = {
    ...
    player2: {
        ...
        name: "Voldemort", 
        hitCount: 0,
        items: [items.fireball]
    }
}

let acitvePlayer = players.player1
...
function draw(){
    ...
    healthBar.style.width = players.player1.HP + "px"
    ...
    healthBarPl2.style.width = players.player2.HP + "px"
